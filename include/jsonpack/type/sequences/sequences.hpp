...
struct sequence_traits<Seq&>
{
    ...
    static void extract(const jsonpack::value &v, char* json_ptr, Seq &value)
    {
        ...
        for(const auto &it : arr)
        {
            ...
            type_t val;
#endif  
            if( json_extract_traits<type_t&,void>::match_token_type(it) )
            {
                json_extract_traits<type_t&,void>::extract(it, json_ptr, val);
...
template<typename T, std::size_t N >
struct json_extract_traits<std::array<T,N>&, void>
{
...
template<typename T>
struct json_extract_traits<std::vector<T>&, void>
{
...
template<typename T>
struct json_extract_traits<std::deque<T>&, void>
{
...
template<typename T>
struct json_extract_traits<std::list<T>&, void>
{
...
template<typename T>
struct json_extract_traits<std::forward_list<T>&, void>
{
...
template<typename T>
struct json_extract_traits<std::set<T>&, void>
{
...
template<typename T>
struct json_extract_traits<std::multiset<T>&, void>
{
...
template<typename T>
struct json_extract_traits<std::unordered_set<T>&, void>
{
